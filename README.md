...
| Faz 5 — Yapay Zeka Katmanı | 6 / 7 | T5.1–T5.4, T5.6, T5.7 tamam (T5.5 kaldı) · katman sağlayıcı anahtarı olmadan **kapalı**; triyaj taraması, protokol sözcük araması ve günlük brifing AI'sız da çalışıyor |
