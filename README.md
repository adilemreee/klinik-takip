...
| AI sağlayıcı sözleşmesi (sıfır saklama) | **Sizde:** §14.5 gereği ve **sağlayıcı başına** — dört seçenek (Claude/GPT/Gemini/DeepSeek) aynı şartları sunmuyor, o yüzden sağlayıcıyı değiştirmek beyanı sıfırlıyor. Beyan yokken klinik istemler gönderilmiyor, gerisi çalışıyor | — |
| AI model fiyatları | **Sizde:** artık ayarlar ekranından giriliyor ve her sağlayıcının fiyat sayfası bağlantısı orada. Depoda fiyat yok, çünkü bütçe koruması verilen sayıya karşı gerçek para harcar ve eskimiş bir fiyat hâlâ inanılır. **Fiyatsız model açılmıyor** | — |
