...
Veri modeli: [docs/VERI-MODELI.md](docs/VERI-MODELI.md) · Dağıtım: [docs/DAGITIM.md](docs/DAGITIM.md) · Yedekleme: [docs/YEDEKLEME.md](docs/YEDEKLEME.md)
...
| Faz 1 — Kimlik ve Çekirdek Veri | 🔄 devam ediyor (T1.1 ✅) |
