...
let package = Package(
    ...
    products: [
        ...
        .library(name: "KlinikExportsFeature", targets: ["KlinikExportsFeature"]),
    ...
    targets: [
        ...
        .target(
            name: "KlinikNotificationsFeature",
            dependencies: ["KlinikAPI", "KlinikCore", "KlinikDesign"]
        ),
        ...
        .target(
            name: "KlinikAppointmentsFeature",
            dependencies: ["KlinikAPI", "KlinikCore", "KlinikDesign"]
        ),
        ...
        // Taking data out of the clinic, and the record of having done so (M12).
        .target(
            name: "KlinikExportsFeature",
            dependencies: ["KlinikAPI", "KlinikCore", "KlinikDesign"]
        ),

        // Patient-reported outcome surveys, and what they say over time (M18).
        .target(
            name: "KlinikSurveysFeature",
            dependencies: ["KlinikAPI", "KlinikCore", "KlinikDesign"]
        ),

        .testTarget(
            name: "KlinikSurveysFeatureTests",
            dependencies: ["KlinikSurveysFeature", "KlinikCore"]
        ),

        // Who looked at what, and the patterns worth a second look (M13).
        .target(
            name: "KlinikAuditFeature",
            dependencies: ["KlinikAPI", "KlinikCore", "KlinikDesign"]
        ),

        // The documents the assistant is allowed to quote (M4).
        .target(
            name: "KlinikProtocolsFeature",
            dependencies: ["KlinikAPI", "KlinikCore", "KlinikDesign"]
        ),

        .testTarget(
            name: "KlinikProtocolsFeatureTests",
        ...
        // Which model the clinic uses, and on what terms (spec section 3.4).
        .target(
            name: "KlinikAISettingsFeature",
            dependencies: ["KlinikAPI", "KlinikCore", "KlinikDesign"]
        ),
